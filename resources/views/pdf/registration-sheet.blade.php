...
<head>
    <meta charset="UTF-8">
    <title>Registration Sheet - {{ $seminar->title }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .table-header th.name-col,
        .table-body td.name-col,
        .table-header th.email-col,
        .table-body td.email-col {
            white-space: normal;
            word-wrap: break-word;
        }
    ...
    <div class="page">
        <div class="content-wrapper">
            ...
            <table class="header-table" style="width: 100%; border-collapse: collapse;">
                ...
                <tr>
                    <td style="border: 1pt solid #000; text-align: center; font-weight: bold; padding: 6pt 0; height: 30pt; background-color: #dbe5f1; vertical-align: middle;">
                        <strong style="font-size: 14pt;">REGISTRATION SHEET</strong>
                    </td>
                </tr>
            </table>
            ...
            <table style="width: 100%; border-collapse: collapse; margin-top: 0;">
                ...
                @endforeach
                {{-- Footer Signature Boxes as part of the same table --}}
                <tr>
...
@else
    {{-- No attendees: still render one blank page --}}
    <div class="page">
        <div class="content-wrapper">
            <table class="header-table" style="width: 100%; border-collapse: collapse;">
                <tr>
            ...
            <table class="footer-table" style="margin-top: auto;">
                <tr>
                    <td>
